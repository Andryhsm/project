<section class="container-fluid">
    ...
    <div>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="date" class="form-control" name="datediagnostic" id="datediagnostic" placeholder="Date de diagnostic">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="date" class="form-control" name="datepremieremisesouspompe" id="datepremieremisesouspompe" placeholder="Date de première mise sous pompe">
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-hover" style="color: white;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" name="imc" id="imc" placeholder=""></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="well">
            ...
            <fieldset>
                <h4>Auto surveillance glycémique :</h4><br>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <input type="date" class="form-control" name="dateprescription" id="dateprescription" placeholder="Date de prescription">
                        </div>
                    </div>
                </div>
        ...
        <div class="well">
            ...
            <div class="form-group">
                <label for="schemamultiinjection" class="col-lg-4 control-label">Schéma multi-injection:</label>
                <div class="col-lg-8">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <label for="autrestylo" class="col-lg-3 control-label">Autre:</label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="autrestylo" id="autrestylo" placeholder="Autre ">
                    </div>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                    <label for="autreaiguille" class="col-lg-3 control-label">Autre:</label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="autreaiguille" id="autreaiguille" placeholder="Autre ">
                    </div>
                </div>
            </div>
            </fieldset>	</br>
            ...
            <fieldset>
                <table class="table table-bordered table-hover" style="color: white;">
                    ...
                    <th style="text-align: center;">Insuline lente</th>
                    <th style="text-align: center;">Insuline rapide</th>
                    <th style="text-align: center;">Quantité totale</th>
                    </thead>
                    <tbody>
                        <tr>
                            <td id="matin">Matin</td>
                            <td><input type="text" class="form-control" name="insulinelentematin" id="insulinelentematin" placeholder=""></td>
                            <td><input type="text" class="form-control" name="insulinerapidematin" id="insulinerapidematin" placeholder=""></td>
                            <td><input type="text" class="form-control" name="quantitetotal" readonly="" id="quantitetotal" placeholder=""></td>
                        </tr>
                        <tr>
                            <td id="midi">Midi</td>
                            <td><input type="text" class="form-control" name="insulinelentemidi" id="insulinelentemidi" placeholder=""></td>
                            <td><input type="text" class="form-control" name="insulinerapidemidi" id="insulinerapidemidi" placeholder=""></td>
                        </tr>
                        <tr>
                            <td id="soir">Soir</td>
                            <td><input type="text" class="form-control" name="insulinelentesoir" id="insulinelentesoir" placeholder=""></td>
                            <td><input type="text" class="form-control" name="insulinerapidesoir" id="insulinerapidesoir" placeholder=""></td>
                        </tr>
                        <tr>
                            <td id="total"><b>Total</b></td>
                            <td><input type="text" class="form-control" name="totalinsulinelente" readonly="" id="totalinsulinelente" placeholder=""></td>
                            <td><input type="text" class="form-control" name="totalinsulinerapide" readonly="" id="totalinsulinerapide" placeholder=""></td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="well">
            <fieldset>
                <table class="table table-bordered table-hover table-responsive" style="color: white;">
                    <thead>
                        <tr>
                            <th style="text-align: center;" colspan="8">Schémas basals date 1</th>
                        </tr>
                        <tr>
                            <td style="text-align: center;" colspan="2">Schémas 1 (ex: semaine)</td>
                            <td style="text-align: center;" colspan="2">Schémas 2 (ex: week-end)</td>
                            <td style="text-align: center;" colspan="2">Schémas 3</td>
                            <td style="text-align: center;" colspan="2">Schémas 4</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">Horaire</td>
                    ...
                    <tbody>
                        <tr>
                            <td><input type="time" class="form-control" name="Horaire1" id="Horaire1"></td>
                            <td><input type="text" class="form-control" name="Debit1" id="Debit1"></td>
                            <td><input type="time" class="form-control" name="Horaire2" id="Horaire2"></td>
                            <td><input type="text" class="form-control" name="Debit2" id="Debit2"></td>
                            <td><input type="time" class="form-control" name="Horaire3" id="Horaire3"></td>
                            <td><input type="text" class="form-control" name="Debit3" id="Debit3"></td>
                            <td><input type="time" class="form-control" name="Horaire4" id="Horaire4"></td>
                            <td><input type="text" class="form-control" name="Debit4" id="Debit4"></td>
                        </tr>
                        <tr>
                            <td><input type="time" class="form-control" name="Horaire5" id="Horaire5"></td>
                            <td><input type="text" class="form-control" name="Debit5" id="Debit5"></td>
                            <td><input type="time" class="form-control" name="Horaire6" id="Horaire6"></td>
                            <td><input type="text" class="form-control" name="Debit6" id="Debit6"></td>
                            <td><input type="time" class="form-control" name="Horaire7" id="Horaire7"></td>
                            <td><input type="text" class="form-control" name="Debit7" id="Debit7"></td>
                            <td><input type="time" class="form-control" name="Horaire8" id="Horaire8"></td>
                            <td><input type="text" class="form-control" name="Debit8" id="Debit8"></td>
                        </tr>
                        <tr>
                            <td><input type="time" class="form-control" name="Horaire9" id="Horaire9"></td>
                            <td><input type="text" class="form-control" name="Debit9" id="Debit9"></td>
                            <td><input type="time" class="form-control" name="Horaire10" id="Horaire10"></td>
                            <td><input type="text" class="form-control" name="Debit10" id="Debit10"></td>
                            <td><input type="time" class="form-control" name="Horaire11" id="Horaire11"></td>
                            <td><input type="text" class="form-control" name="Debit11" id="Debit11"></td>
                            <td><input type="time" class="form-control" name="Horaire12" id="Horaire12"></td>
                            <td><input type="text" class="form-control" name="Debit12" id="Debit12"></td>
                        </tr>
                        <tr>
                            <td><input type="time" class="form-control" name="Horaire13" id="Horaire13"></td>
                            <td><input type="text" class="form-control" name="Debit13" id="Debit13"></td>
                            <td><input type="time" class="form-control" name="Horaire14" id="Horaire14"></td>
                            <td><input type="text" class="form-control" name="Debit14" id="Debit14"></td>
                            <td><input type="time" class="form-control" name="Horaire15" id="Horaire15"></td>
                            <td><input type="text" class="form-control" name="Debit15" id="Debit15"></td>
                            <td><input type="time" class="form-control" name="Horaire16" id="Horaire16"></td>
                            <td><input type="text" class="form-control" name="Debit16" id="Debit16"></td>
                        </tr>
                    </tbody>
                </table></br></br>
                ...
                <table class="table table-bordered table-hover  table-responsive" style="color: white;">
                    <thead>
                        <tr>
                            <th style="text-align: center;" colspan="8">Schémas basals date 2</th>
                        </tr>
                        <tr>
                            <td style="text-align: center;" colspan="2">Schémas 1 (ex: semaine)</td>
                            <td style="text-align: center;" colspan="2">Schémas 2 (ex: week-end)</td>
                    ...
                    <tbody>
                        <tr>
                            <td><input type="time" class="form-control" name="Horaire21" id="Horaire21"></td>
                            <td><input type="text" class="form-control" name="Debit21" id="Debit21"></td>
                            <td><input type="time" class="form-control" name="Horaire22" id="Horaire22"></td>
                            <td><input type="text" class="form-control" name="Debit22" id="Debit22"></td>
                            <td><input type="time" class="form-control" name="Horaire23" id="Horaire23"></td>
                            <td><input type="text" class="form-control" name="Debit23" id="Debit23"></td>
                            <td><input type="time" class="form-control" name="Horaire24" id="Horaire24"></td>
                            <td><input type="text" class="form-control" name="Debit24" id="Debit24"></td>
                        </tr>
                        <tr>
                            <td><input type="time" class="form-control" name="Horaire25" id="Horaire25"></td>
                            <td><input type="text" class="form-control" name="Debit25" id="Debit25"></td>
                            <td><input type="time" class="form-control" name="Horaire26" id="Horaire26"></td>
                            <td><input type="text" class="form-control" name="Debit26" id="Debit26"></td>
                            <td><input type="time" class="form-control" name="Horaire27" id="Horaire27"></td>
                            <td><input type="text" class="form-control" name="Debit27" id="Debit27"></td>
                            <td><input type="time" class="form-control" name="Horaire28" id="Horaire28"></td>
                            <td><input type="text" class="form-control" name="Debit28" id="Debit28"></td>
                        </tr>
                        <tr>
                            <td><input type="time" class="form-control" name="Horaire29" id="Horaire29"></td>
                            <td><input type="text" class="form-control" name="Debit29" id="Debit29"></td>
                            <td><input type="time" class="form-control" name="Horaire210" id="Horaire210"></td>
                            <td><input type="text" class="form-control" name="Debit210" id="Debit210"></td>
                            <td><input type="time" class="form-control" name="Horaire211" id="Horaire211"></td>
                            <td><input type="text" class="form-control" name="Debit211" id="Debit211"></td>
                            <td><input type="time" class="form-control" name="Horaire212" id="Horaire212"></td>
                            <td><input type="text" class="form-control" name="Debit212" id="Debit212"></td>
                        </tr>
                        <tr>
                            <td><input type="time" class="form-control" name="Horaire213" id="Horaire213"></td>
                            <td><input type="text" class="form-control" name="Debit213" id="Debit213"></td>
                            <td><input type="time" class="form-control" name="Horaire214" id="Horaire214"></td>
                            <td><input type="text" class="form-control" name="Debit214" id="Debit214"></td>
                            <td><input type="time" class="form-control" name="Horaire215" id="Horaire215"></td>
                            <td><input type="text" class="form-control" name="Debit215" id="Debit215"></td>
                            <td><input type="time" class="form-control" name="Horaire216" id="Horaire216"></td>
        ...
        <div class="well table-responsive">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <textarea rows="5" cols="1" class="form-control" id="synthesecommentqire" placeholder="Synthèse/Commentaires"></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <table class="table table-bordered table-hover" style="color: white;">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="date" class="form-control" name="ValDatesHemGlyc1" id="ValDatesHemGlyc1"></td>
                            <td><input type="date" class="form-control" name="ValDatesHemGlyc2" id="ValDatesHemGlyc2"></td>
                            <td><input type="date" class="form-control" name="ValDatesHemGlyc3" id="ValDatesHemGlyc3"></td>
                            <td><input type="date" class="form-control" name="ValDatesHemGlyc4" id="ValDatesHemGlyc4"></td>
                            <td><input type="date" class="form-control" name="ValDatesHemGlyc5" id="ValDatesHemGlyc5"></td>
                            <td><input type="date" class="form-control" name="ValDatesHemGlyc6" id="ValDatesHemGlyc6"></td>
                            <td><input type="date" class="form-control" name="ValDatesHemGlyc7" id="ValDatesHemGlyc7"></td>
                            <td><input type="date" class="form-control" name="ValDatesHemGlyc8" id="ValDatesHemGlyc8"></td>
                            <td><input type="date" class="form-control" name="ValDatesHemGlyc9" id="ValDatesHemGlyc9"></td>
                        </tr>
                        <tr>
